...
class PlayerPositionApiTest extends TestCase
{
    ...
    {
        $playerPosition = factory(PlayerPosition::class)->make()->toArray();
    ...
    {
        $playerPosition = factory(PlayerPosition::class)->create();
    ...
    {
        $playerPosition = factory(PlayerPosition::class)->create();
        $editedPlayerPosition = factory(PlayerPosition::class)->make()->toArray();
